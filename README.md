...
> *На графике слева — горизонтальные полосы с Accuracy каждой модели.  
> На графике справа — матрица ошибок лучшей модели (Gradient Boosting).*

```
+----------------------------+---------------------------+
|  Сравнение моделей (Acc.)  | Матрица ошибок (GB)       |
|                            |                           |
|  Gradient Boosting ▓▓▓▓▓  |        Предсказание       |
|  Random Forest     ▓▓▓▓   |          0      1         |
|  AdaBoost          ▓▓▓▓   |  Факт 0 [97]   [13]       |
|  Bagging           ▓▓▓    |       1 [16]   [53]       |
+----------------------------+---------------------------+
```
